...
<input class="input-style" type="text" name="country" value="<%=rs2.getString(10)%>" placeholder="Enter Country">
        ...
        <div class="left-div">
            ...
            <select  class="input-style" name="paymentMethod">
                <option vlaue="Cash on delivery(COD)">Cash on delivery(COD)</option>
                 <option vlaue="Online payment">Online payment</option>
            </select>
        </div>

        <div class="right-div">
            <h3>Pay online on this shoppingpoint@pay.com</h3>
<input class="input-style" type="text" name="transactionId"  placeholder="Enter TransactionId">
        ...
        <div class="left-div">
            <h3>Mobile Number</h3>
            <input class="input-style" type="number" name="mobilenumber" value="<%=rs2.getString(3)%>" placeholder="Enter Mobile Number">
